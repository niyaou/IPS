...
public class CustumAction extends BaseRestHandler {
    ...
    public CustumAction(Settings settings, RestController restController) {
        super(settings);
        restController.registerHandler(GET, "/_hello1/_search", this);
        restController.registerHandler(POST, "/_hello1/_search", this);
        restController.registerHandler(GET, "/_hello1/{index}/_search", this);
        restController.registerHandler(POST, "/_hello3/{index}/_search", this);
        restController.registerHandler(GET, "/_hello1/{index}/{type}/_search", this);
        restController.registerHandler(POST, "/_hello1/{index}/{type}/_search", this);
    }
...
//    }
    ...
    protected RestChannelConsumer prepareRequest(RestRequest request, NodeClient client) throws IOException {
        ...
        return channel -> client.search(searchRequest, new SqlHitsActionListener(channel));
    }
