...
(function (ls) {
    ...
    var GestureBehavior = (function (_super) {
        ...
        GestureBehavior.DOUBLE_TAP_TIME = 300;
        GestureBehavior.DOUBLE_TAP_DISTANCE = 80;
        GestureBehavior.SHORT_TAP_TIME = 400;
        GestureBehavior.LONG_TAP_TIME = 800;
        GestureBehavior.SWIPE_DISTANCE = 150;
        GestureBehavior.SWIPE_TIME = 200;
        GestureBehavior.SWIPE_POINT_NUMS = 30;
